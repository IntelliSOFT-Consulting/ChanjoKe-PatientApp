...
export default function VaccinationSchedule() {
          ...
          <Tag
            color={
              text === "completed"
                ...
                ? "red"
                : missed && text !== "Contraindicated" && text !== "Not Administered"
                ? "red"
  ...
  const { loader, recommendations, fetchUserRecommendations } = useImmunizationRecommendation();
  const { immunizations, fetchPatientImmunizations } = useImmunization();
